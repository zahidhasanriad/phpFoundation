 ...
 function getInfoFromGenres($genre)
    {   
        ...
        else if($genre == $films['genres'][1])
        {
            ...
            echo 'Stars : '.$films['stars'][1].' ('.  strtolower($film['stars'][1]).')<br/>'.str_replace(" ","-", strtolower($films['stars'][0]));
        ...
        else if($genre == $film['genres'][2])
        {
            ...
            echo 'Stars : '.$films['stars'][2].' ('.  strtolower($films['stars'][2]).')<br/>'.str_replace(" ","-", strtolower($films['stars'][0]));
        ...
        else if($genre == $films['genres'][3])
        {
            ...
            echo 'Stars : '.$films['stars'][3].' ('.  strtolower($films['stars'][3]).')<br/>'.str_replace(" ","-", strtolower($films['stars'][0]));
